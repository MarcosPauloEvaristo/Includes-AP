		...
		<div class="row"> 
			<div class="col-md-8 col-md-offset-2">  
				...
				<div id="sendnewpass" class="indent_title_in">
					...
					<p>
						<p><span style="color: red;"> <b>OBS:</b> CADASTRE PRIMEIRO O TIPO E DEPOIS O TAMANHO.</span></p>
					...
					<button data-toggle="modal" data-target="#modaladdtipo" class="btn btn-success" style="width: 100px;"><strong>+ Novo Tipo</strong></button>
					<button data-toggle="modal" data-target="#modaladdtamanho"  class="btn btn-success" style="width: 130px;"><strong>+ Novo Tamanho</strong></button>					
										...
										<div class="form-group">
											...
											<div id="opcao" style="visibility: hidden;">
												...
												<div class="icheck-material-green">
													...
													<label for="meioameioum">Soma valor do item e tamanho.</label>
												</div>
												<div class="icheck-material-green">
