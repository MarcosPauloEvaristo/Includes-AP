		...
		<div class="row"> 
			<div class="col-md-8 col-md-offset-2"> 
				...
				<div id="sendnewpass" class="indent_title_in">
					...
					<h3><strong>CATEGORIAS DE COMPLEMENTOS PAGOS E GRÁTIS</strong></h3>
						...
						<div class="row">							
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label for="nome_adicional_gratis">Nome da categoria</label>
                            ...
                            <div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label for="nome_adicional_gratis">Quantidade de complementos</label>
