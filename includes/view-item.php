...
//FIM PAGINAÇÃO
              ...
              <td><input type="number" data-produtoid="<?php $id;?>" class="form-control numero posicao" name="id" min="1" max="1000" value="<?php (!empty($posicao) ? $posicao : "")?>" placeholder="0">
              </td>
...
<script type="text/javascript">
  $('.posicao').change(function (){
    ...
    $.ajax({
      url: '<?php echo $site; ?>controlers/edit-opcao-posicao.php',
      method: "post",
