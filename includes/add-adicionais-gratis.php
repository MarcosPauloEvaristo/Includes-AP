		...
		<div class="row"> 
			<div class="col-md-8 col-md-offset-2"> 
				...
				<div id="sendnewpass" class="indent_title_in">
					...
					<p>
						<p><span style="color: red;"> <b>OBS:</b> PARA CADASTRAR COMPLEMENTO - PRIMEIRO CADASTRE A CATEGORIA DO COMPLEMENTO.</span></p>
						...
						<div class="row">							
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label for="nome_adicional_gratis">Nome Do Complemento Grátis</label>
