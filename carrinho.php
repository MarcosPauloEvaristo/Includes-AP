	...
	<div class="row"
		<div class="col-md-3">
			<div class="box_style_2 info">
			    <div
			    <br /><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> <strong>FALTA POUCO PARA CONCLUIR SEU PEDIDO!
					...
					<?php if($_POST['opcao_delivery'] == 'true'): ?>
						...
						<div class="box_style_2" id="order_process">				
							...
							<?php if($_POST['opcao_delivery'] == 'true'):?>	
								...
								if ($delivery_distance_type == 'district'):
								...
								if ($delivery_distance_type == 'distance_rate' && $_POST['opcao_delivery'] == 'true'):
								?>
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											<label for="cidade"><span style="color: red;">* </span><?=$texto['msg_sua_cidade'];?></label>
											<input type="text" onfocusout="deliveryRateCalculate()" value="<?=($bairrosstatus == 'false' ? $cidade_empresa : '');?>" required id="cidade" name="cidade" size="40" class="form-control" placeholder="">
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											<label for="uf"><span style="color: red;">* </span><?=$texto['msg_seu_estado'];?></label>
											<input type="text" onfocusout="deliveryRateCalculate()" value="<?=($bairrosstatus == 'false' ? $end_uf_empresa : '');?>" required id="uf" name="uf" size="2" class="form-control" placeholder="">
										</div>
									</div>
<div class="form-group">
											<label for="bairro"><span style="color: red;">* </span><?=$texto['msg_seu_b'];?></label>
								...
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											...
											<input type="text" required onfocusout="deliveryRateCalculate()" autocomplete="off" id="rua" name="rua" size="60" class="form-control" placeholder="">
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											<label for="unidade"><span style="color: red;">* </span><?=$texto['msg_seu_n'];?></label>
											<input type="tel" required onfocusout="deliveryRateCalculate()" autocomplete="off" id="xx55" data-mask="#########0" name="unidade" size="60" class="form-control" placeholder="">
										</div>
									</div>
								...
								<div class="form-group">
									<label for="observacao"><?=$texto['msg_obs_endereco'];?> (Opcional)</label>
							...
							<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">								
											<div class="icheck-material-grey">
												...
												<label for=""><strong><?=$texto['msg_msg_enviarzap'];?></strong></label>
											</div>
										</div>
									</div>
								...
								<span style="color: red;"><b>ATENÇÃO:</b>
									<br /><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Nunca passe seus dados do cartão pelo <strong>WHATSAPP!</strong>
									<br /><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Todo o Processo é Feito De Forma Segura e Registrado Dentro Da Lei.
								</span>
							</div><!-- End box_style_1 -->
							...
							<div class="theiaStickySidebar">
								...
								// Get all items in the cart
									...
									if ($type_pay == 0) {
									    ...
									    <button id="btn_pedir_agora" class="btn_full enviarpedido" <?php if ($_POST['opcao_delivery'] == 'true') echo 'disabled'; ?>><?=$texto['msg_pedir_agora'];?></button>
									    <?
									}
									else if ($type_pay == 1) {
									    ?>
									    <button id="btn_pedir_agora" class="btn_full enviarpedido btn_disabled" <?php if ($_POST['opcao_delivery'] == 'true') echo 'disabled'; ?>><?=$texto['msg_pedir_agora'];?></button>
									    <?
									}
									else if ($type_pay == 2) {
									    ?>
